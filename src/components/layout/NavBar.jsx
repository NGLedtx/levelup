...
function NavBar() {
  return (
    <nav className="flex justify-center mt-5 text-white bg-gray-800 rounded-xl shadow fixed bottom-0 left-0 w-full">
      <ul className="flex items-center gap-10 text-2xl p-4">
        <li>
